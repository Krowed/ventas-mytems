            ...
            <div class="card-body relative overflow-hidden bg-zinc-900 rounded-md mb-5">
                <div class="relative z-10 grid grid-cols-12 items-center">
                    ...
                    <div class="col-span-4 ms-auto lg:block hidden">
                        <img src="{{ asset('assets/dashboard-BxFgfF4y.png') }}" alt="" class="h-40">
                    </div>
                </div>
                ...
                <div class="card-header">
                    ...
                    <div class="relative">
                        <input type="text" data-provider="flatpickr" data-date-format="d M, Y" data-range-date="true"
                            placeholder="Select Date" class="form-input form-input-sm ps-9" />
                        ...
                        <div class="col-span-1">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <h5 class="text-base font-semibold text-default-800">$<span class="counter-value"
                    ...
                    <div class="grid md:grid-cols-12 grid-cols-1">
                        ...
                        <div class="md:col-span-5 col-span-1">
                            <div class="flex flex-col gap-3">
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="bg-info size-3" style="clip-path: polygon(50% 0%, 0% 100%, 100% 100%);">
                                    </div>
                ...
                <div>
                    ...
                    <div class="divide-y divide-default-200 dark:divide-white/14">
                        <div class="flex items-center justify-between text-sm">
                            <div class="flex items-center gap-3 py-2.25">
                                <div class="size-8 rounded-full bg-default-100">
                                    <img src="{{ asset('assets/avatar-2-B613dbkY.png') }}" alt=""
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <div class="flex items-center gap-3 py-2.25">
                                <div class="size-8 rounded-full bg-default-100">
                                    <img src="{{ asset('assets/avatar-3-CuoB696V.png') }}" alt=""
                                        class="size-8 rounded-full">
                                </div>
                                <div>
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <div class="flex items-center gap-3 py-2.25">
                                <div class="size-8 rounded-full bg-default-100">
                                    <img src="{{ asset('assets/avatar-4-CCRr3MbC.png') }}" alt=""
                                        class="size-8 rounded-full">
                                </div>
                                <div>
                        ...
                        <div class="flex items-center justify-between text-sm">
                            <div class="flex items-center gap-3 pt-2">
                                <div class="size-8 rounded-full bg-default-100">
                                    <img src="{{ asset('assets/avatar-5-ACaGxkSo.png') }}" alt=""
                                        class="size-8 rounded-full">
                                </div>
                                <div>
            ...
            <div class="card-body">
                <div class="flex flex-col gap-5">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3 whitespace-nowrap">
                            <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                <img src="{{ asset('assets/img-02-C91JHf1M.png') }}" alt="" class="h-6">
                            </div>

                            <div>
                                <h6 class="font-semibold text-default-800 md:w-full truncate w-43 mb-1 text-sm">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                <img src="{{ asset('assets/img-03-C8EnjP1K.png') }}" alt="" class="h-6">
                            </div>
                            <div>
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                <img src="{{ asset('assets/img-04-BzlzTEbH.png') }}" alt="" class="h-6">
                            </div>
                            <div>
                                <h6 class="font-semibold text-default-800 md:w-full truncate w-43 text-sm mb-1">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                <img src="{{ asset('assets/img-05-RFpkKl-c.png') }}" alt="" class="h-6">
                            </div>
                            <div>
                                <h6 class="font-semibold text-default-800 md:w-full truncate w-43 text-sm mb-1">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                <img src="{{ asset('assets/img-06-joo6Gm4I.png') }}" alt="" class="h-6">
                            </div>
                            <div>
                                <h6 class="font-semibold text-default-800 md:w-full truncate w-43 text-sm mb-1">
