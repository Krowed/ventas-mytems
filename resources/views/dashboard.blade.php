...
<head>
    <meta charset="utf-8">
    <title>index | Tailwick - Tailwind CSS 3 Admin Layout & UI Kit Template</title>
...
.sidebar-collapsed .logo-lg {
  ...
  <script type="module" crossorigin src="assets/index-CmxHtAW3.js"></script>
  <link rel="modulepreload" crossorigin href="assets/app-APNOAydp.js">
  ...
  <link rel="stylesheet" crossorigin href="assets/app-HMWHReTH.css">
</head>
...
<a href="index.html"
   class="logo-box sticky top-0 flex min-h-topbar-height items-center justify-center px-6 gap-3">
    ...
    <!-- Logo pequeño M -->
    <span
        class="logo-sm flex h-9 w-9 items-center justify-center
                    ...
                    <div class="flex items-center gap-3">
                                        ...
                                        <a href="#" class="flex gap-3 p-4 items-center hover:bg-default-150">
                                            <div>
                                                <div class="size-10 rounded-md  bg-default-100">
                                                    <img src="/tailwick/layouts/assets/avatar-3-CuoB696V.png" alt="" class="rounded-md">
                                                </div>
                                            </div>
                                        ...
                                        <a href="#" class="flex gap-3 p-4 items-start hover:bg-default-150">
                                            <div>
                                                <div class="size-10 rounded-md  bg-warning/10">
                                                    <img src="/tailwick/layouts/assets/avatar-5-ACaGxkSo.png" alt="" class="rounded-md">
                                                </div>
                                            </div>
                                        ...
                                        <a href="#" class="flex gap-3 p-4 items-center hover:bg-default-150">
                                            <div class="relative">
                                                <div class="size-10 rounded-md  bg-pink-100">
                                                    <img src="/tailwick/layouts/assets/avatar-7-QY-kCwjM.png" alt="" class="rounded-md">
                                                </div>
                        ...
                        <div class="topbar-item hs-dropdown relative inline-flex">
                            <button class="cursor-pointer bg-pink-100 rounded-full" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
                                <img src="assets/avatar-1-DOkfBXSU.png" alt="user-image" class="hs-dropdown-toggle rounded-full size-9.5">
                            </button>
                                    ...
                                    <a href="#!" class="flex gap-3">
                                        <div class="relative inline-block">
                                            <div class="rounded bg-default-200">
                                                <img src="assets/avatar-1-DOkfBXSU.png" alt="" class="size-12 rounded">
                                            </div>
            ...
            <main>
                ...
                <div class="flex items-center md:justify-between flex-wrap gap-2 mb-4 print:hidden">
                    ...
                    <div class="md:flex hidden items-center gap-2 text-sm font-semibold">
                        ...
                        <a href="#" class="text-sm font-medium text-default-700" aria-current="page">Ecommerce</a>
                    </div>
                </div>
                <!-- Page Title End -->
                        ...
                        <div class="card-body relative overflow-hidden bg-zinc-900 rounded-md mb-5">
                            <div class="relative z-10 grid grid-cols-12 items-center">
                                ...
                                <div class="col-span-4 ms-auto lg:block hidden">
                                    <img src="/tailwick/layouts/assets/dashboard-BxFgfF4y.png" alt="" class="h-40">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="divide-y divide-default-200 dark:divide-white/14">
                                    <div class="flex items-center justify-between text-sm">
                                        <div class="flex items-center gap-3 py-2.25">
                                            <div class="size-8 rounded-full bg-default-100">
                                                <img src="/tailwick/layouts/assets/avatar-2-B613dbkY.png" alt="" class="size-8 rounded-full">
                                            </div>
                                            <div>
                                    ...
                                    <div class="flex items-center justify-between text-sm">
                                        <div class="flex items-center gap-3 py-2.25">
                                            <div class="size-8 rounded-full bg-default-100">
                                                <img src="/tailwick/layouts/assets/avatar-3-CuoB696V.png" alt="" class="size-8 rounded-full">
                                            </div>
                                            <div>
                                    ...
                                    <div class="flex items-center justify-between text-sm">
                                        <div class="flex items-center gap-3 py-2.25">
                                            <div class="size-8 rounded-full bg-default-100">
                                                <img src="/tailwick/layouts/assets/avatar-4-CCRr3MbC.png" alt="" class="size-8 rounded-full">
                                            </div>
                                            <div>
                                    ...
                                    <div class="flex items-center justify-between text-sm">
                                        <div class="flex items-center gap-3 pt-2">
                                            <div class="size-8 rounded-full bg-default-100">
                                                <img src="/tailwick/layouts/assets/avatar-5-ACaGxkSo.png" alt="" class="size-8 rounded-full">
                                            </div>
                                            <div>
                        ...
                        <div class="card-body">
                            <div class="flex flex-col gap-5">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3 whitespace-nowrap">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="/tailwick/layouts/assets/img-02-C91JHf1M.png" alt="" class="h-6">
                                        </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="/tailwick/layouts/assets/img-03-C8EnjP1K.png" alt="" class="h-6">
                                        </div>
                                        <div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="/tailwick/layouts/assets/img-04-BzlzTEbH.png" alt="" class="h-6">
                                        </div>
                                        <div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="/tailwick/layouts/assets/img-05-RFpkKl-c.png" alt="" class="h-6">
                                        </div>
                                        <div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center gap-3">
                                        <div class="flex items-center justify-center rounded-md size-10 bg-default-100">
                                            <img src="/tailwick/layouts/assets/img-06-joo6Gm4I.png" alt="" class="h-6">
                                        </div>
                                        <div>
